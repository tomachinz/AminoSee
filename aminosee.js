...
let proteinBrightness = 0.20;
let startStopBrightness = 4.0;
...
module.exports = () => {
  ...
  args = minimist(process.argv.slice(2), {
    ...
    string: [ 'codons'],
    string: [ 'peptide'],
    alias: { a: 'artistic', c: 'codons', f: 'force', d: 'devmode', m: 'megapixels', p: 'peptide', s: 'spew', w: 'width', v: 'verbose', z: 'codons' },
