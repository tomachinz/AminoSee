...
COMMAND="gource --date-format '%d / %m / %Y %a' --camera-mode overview -1440x960 --seconds-per-day 0.2 --auto-skip-seconds 0.1 --max-file-lag 0.01 --background-image src/public/WhitePaper_800px.png --logo src/public/funk-logo-140px.png  --font-size 14 --key --bloom-multiplier 0.125 --bloom-intensity 0.125 --background 012345  -e 0.75 --title 'github.com/tomachinz/AminoSee'"
echo About to run...:
echo $COMMAND
sleep 1
eval $COMMAND
