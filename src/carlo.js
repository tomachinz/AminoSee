...
function startCarlo() {
  (async () => {
    ...
    await app.load('http://127.0.0.1:43210/public/carlo.html').then( () => { console.log(`rugby was the winner`) }).catch( await app.load('http://127.0.0.1:4321/public/carlo.html') );
  })();
}
startCarlo();
//
