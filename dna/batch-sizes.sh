...
aminosee_do () {
  ...
  nice -n $1 aminosee $2 $3 $4 $5 $6    -p=proline &
  nice -n $1 aminosee $2 $3 $4 $5 $6    -p=alanine
...
many_size_hilbert() {
  ...
  aminosee_do 1  --ratio=sqr -m 9 --reg $1 $2 $3 $4 $5 $6


  aminosee_do 1 $1 $2 $3 $4 $5 $6                --ratio=gold
  aminosee_do 1 $1 $2 $3 $4 $5 $6        -c 2        --ratio=gold
  aminosee_do 1 $1 $2 $3 $4 $5 $6        -c 4        --ratio=gold
  aminosee_do 2 $1 $2 $3 $4 $5 $6        -c 10   --ratio=gold
  aminosee_do 3 $1 $2 $3 $4 $5 $6       -c 100  --ratio=gold
  aminosee_do 6 $1 $2 $3 $4 $5 $6       -c 500 --ratio=gold
  aminosee_do_foreground 7 $1 $2 $3 $4 $5 $6       -c 1000 --ratio=gold
