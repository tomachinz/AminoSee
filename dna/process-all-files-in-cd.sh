...
aminosee homo-sapien-hs_ref_GRCh38.p12_chr2.fa -d -z 8
aminosee homo-sapien-hs_ref_GRCh38.p12_chr2.fa -d -z 7
aminosee homo-sapien-hs_ref_GRCh38.p12_chr2.fa -d -z 6
aminosee homo-sapien-hs_ref_GRCh38.p12_chr2.fa -d -z 5

find . -name "*.fa"  -type f -print0 | xargs -0 aminosee -d -f  --zoom 10
find . -name "*.mfa" -type f -print0 | xargs -0 aminosee -d -f  --zoom 10
find . -name "*.gbk" -type f -print0 | xargs -0 aminosee -d -f  --zoom 10
find . -name "*.txt" -type f -print0 | xargs -0 aminosee -d -f  --zoom 10
find . -name "*.dna" -type f -print0 | xargs -0 aminosee -d -f  --zoom 10

find . -name "*.fa"  -type f -print0 | xargs -0 aminosee -d -f  --zoom 3
find . -name "*.mfa" -type f -print0 | xargs -0 aminosee -d -f  --zoom 3
find . -name "*.gbk" -type f -print0 | xargs -0 aminosee -d -f  --zoom 3
find . -name "*.txt" -type f -print0 | xargs -0 aminosee -d -f  --zoom 3
find . -name "*.dna" -type f -print0 | xargs -0 aminosee -d -f  --zoom 3
