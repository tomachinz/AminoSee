...
aminosee homo-sapien-hs_ref_GRCh38.p12_chr2.fa -v -d -z 4
aminosee homo-sapien-hs_ref_GRCh38.p12_chr2.fa -v -d -z 3
aminosee homo-sapien-hs_ref_GRCh38.p12_chr2.fa -v -d -z 2

find . -name "*.fa"  -type f -print0 | xargs -0 aminosee -v -d  --zoom 10
find . -name "*.mfa" -type f -print0 | xargs -0 aminosee -v -d  --zoom 10
find . -name "*.gbk" -type f -print0 | xargs -0 aminosee -v -d  --zoom 10
find . -name "*.txt" -type f -print0 | xargs -0 aminosee -v -d  --zoom 10
find . -name "*.dna" -type f -print0 | xargs -0 aminosee -v -d  --zoom 10
