...
COMMAND="/usr/bin/rsync --archive --verbose --delete --dry-run --stats  --exclude={"*_linear_[ABCDEFGHIJKLMNOPQRSTUVWXYZ]"} tom@cheese:/home/tom/Sites/AminoSee/dna/AminoSee_Output/  /Users/tom/AminoSee_Output/"
