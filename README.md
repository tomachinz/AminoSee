...
Tested with files as large as an entire Chimpanzee genome 3.11 GB - AminoSee looks at the file size, makes an estimate of how many codon triplets are present, and starts blending just over 100 codons per pixel in a 9 megapixels image. Smaller microbes and the C.Elegans worm can be seen at 1 pixel per codon resolution on a large 4k monitor!
